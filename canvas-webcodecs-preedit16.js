(() => {
  ...
  window.wcTracker = { analyze: analyzeFaceTrack, relink: relinkTrack, seedByClick, cancelSeed, marker: trackMarker, boxes: trackBoxes, ensureDetector: ensureFaceDetector, captureFace };
  let _debug = false;
  let _ready = false;
