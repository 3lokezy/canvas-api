(function () {
  ...
  const _RENDER_SCRIPT_BUILD = 'pb-20260502g-ended-guard';
      ...
      rv.addEventListener('seeked', async function onSeeked() {
        ...
        async function emitFrameAt(index) {
          ...
          if (useMp4) {
            ...
            if (!_iosSeekMode) {
              // Don't try to play an already-ended video — play() on an ended
              // element can stall the encoder or restart from t=0 on some browsers.
              if (!rv.ended) {
