(function () {
  ...
  function initFacecamCanvas(item, gpVideo, fcHold, x1, y1, x2, y2) {
    ...
    function drawFrame() {
      // While gpVideo is seeking (e.g. a clip-transition seek) it momentarily has no frame;
      // drawing it would clear the canvas to blank and flash. Hold the last good frame instead.
