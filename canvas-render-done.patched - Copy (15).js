(function () {
  ...
  const _RENDER_SCRIPT_BUILD = 'pb-20260501k-ios-remux';
    ...
    if (useMp4) {
      ...
      setupMp4AudioSource = async () => {
        ...
        if (typeof AudioEncoder === 'undefined') {
          ...
          // Extract raw AAC samples from the source container for post-finalize remux.
          if (_isIOS && _mbMp4 && !rawAudioData) {
            try {
              rawAudioData = await extractRawMp4Audio(
