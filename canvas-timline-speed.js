(function () {
  ...
  function mountNLETrack(masterRow, api, getDisplayDuration) {
    ...
    const ro = new ResizeObserver(() => {
      ...
      const scale = newW / trackW;   // only for the rare no-model-match fallback below
      trackW = newW;
      // RECOMPUTE each bar's left+width straight from the MODEL at the new track width, with a 2px
