(() => {
  ...
  window.wcTracker = { analyze: analyzeFaceTrack, scan: scanScenes, relink: relinkTrack, linkFromScan, seedByClick, cancelSeed, marker: trackMarker, boxes: trackBoxes, ensureDetector: ensureFaceDetector, captureFace };
  let _debug = false;
  let _ready = false;
